...
def create_calculated_fields_for_cargo(existing_values: Dict) -> Dict:
    capacity = extract_number(existing_values.get("quantity", ""))
    # check if capacity is less than 3 digits, then multiply by 1000
    if capacity and capacity < 1000:
        capacity = capacity * 1000
...
class MongoShip(BaseModel):
    ...
    id: Optional[Any] = Field(alias="_id")# ID of the ship generated by MongoDB
...
class MongoCargo(BaseModel):
    id: Optional[Any] = Field(alias="_id") # ID of the cargo generated by MongoDB
